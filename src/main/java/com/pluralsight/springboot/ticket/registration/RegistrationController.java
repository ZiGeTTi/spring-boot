...
public class RegistrationController {
    ...
    public Registration update(@RequestBody Registration registration) {
        ...
        var existingRegistration = registrationRepository.findByTicketCode(ticketCode).orElseThrow(()->new NoSuchElementException("Registration with ticket code " + ticketCode + " not found"));

        return registrationRepository.save(new Registration(existingRegistration.id(), existingRegistration.productId(),ticketCode, registration.attendeeName()));
    }
